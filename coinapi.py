...
FOOTURL = "&disabledExchangesList=Pathfinder,Oasis,Kyber,Uniswap,Balancer,Bancor,PMM2,0x Relays,Mooniswap,PMM"
...
def Uniswapv2(from_coin, to_coin, amount, DEBUG=False):
    return get_coin_amount(from_coin, to_coin, amount, footurl = FOOTURL + ",Curve.fi sUSD", DEBUG=DEBUG)
